...
alias pingsweep='$HOME/pingsweep.sh'
alias v='vim'
alias ls='lsd'
alias ll='lsd -al'
alias lt='ls --tree'
...
alias htblab='sudo openvpn ~/htbvpn/lab_TWM.ovpn &'
alias htbstartingpoint='sudo openvpn ~/htbvpn/starting_point_TWM.ovpn &'
alias vpnkill='sudo pkill openvpn'
alias htbreleasearena='sudo openvpn ~/htbvpn/release_arena_TWM.ovpn &'
alias thmvpn='sudo openvpn ~/thmvpn/tweiseth.ovpn &'
alias hosts='sudo vim /etc/hosts'
alias pl='cat .zshrc | grep "()" | tr -d "(){}" | tr -d [:blank:] | grep -v help ; alias | cut -d "=" -f1'
alias xcp='clip.exe'
alias bloodhound='exec /home/tweiseth/BloodHound-linux-x64/BloodHound &'
alias c:='/mnt/c'
alias d:='/mnt/d'
alias e:='/mnt/e'
alias f:='/mnt/f'
